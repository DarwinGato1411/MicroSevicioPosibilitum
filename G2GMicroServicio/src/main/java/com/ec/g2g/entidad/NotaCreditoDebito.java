...
public class NotaCreditoDebito implements Serializable {
	...
	public void setDetalleNotaDebitoCreditoCollection(
			Collection<DetalleNotaDebitoCredito> detalleNotaDebitoCreditoCollection) {
	...
	public boolean equals(Object object) {
		...
		if ((this.idNota == null && other.idNota != null)
				|| (this.idNota != null && !this.idNota.equals(other.idNota))) {
			return false;
		}
		return true;
	}
